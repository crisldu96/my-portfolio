...
export type AWSCognitoContextType = {
  ...
  register: (email: string, password: string, values: any) => Promise<unknown>;
  confirmCodeRegister: (email: string, code: string) => Promise<unknown>;
  resendCodeRegister: (email: string) => Promise<unknown>;
  resetPassword: (email: string) => void;
  getListAllUsers: () => Promise<unknown>;
